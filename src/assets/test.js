...
import RoundStarter from './RoundStarter.js'
...
export default class Game {
  ...
  update(deltaTime) {
    ...
    this.enemies.push(new RoundStarter(this, 0, 0))

    let roundStarterDestroyed = true
    this.enemies.forEach((enemy) => {
        if (enemy instanceof RoundStarter && !enemy.markedForDeletion) {
            roundStarterDestroyed = false
        }
    })

    if (roundStarterDestroyed) {
